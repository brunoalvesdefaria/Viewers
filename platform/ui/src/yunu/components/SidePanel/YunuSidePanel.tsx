      ...
      <>
        ...
        >
          {_childComponents.map((childComponent, index) => (
            <div
              className="flex cursor-pointer px-4 py-1 flex-col justify-center items-center text-center text-white"
              key={index}
              onClick={event => {
            ...
            >
              ...
              <span className="text-[12px] select-none whitespace-nowrap mt-[5px]">
